...
public class CommandManager2 extends CommandManager {
    ...
    {
		this(inetaddr, false);
        Log.i("CommandManager1", "Constructor");
	}

	public CommandManager2(InetAddress inetaddr,boolean useHighRezVideoStreaming)
    {
		super(inetaddr);
        Log.i("CommandManager", "useHighRezVideoStreaming: " + useHighRezVideoStreaming);
